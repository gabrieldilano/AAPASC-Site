...
export default function MxAapasc() {
  return (
    <div className="flex justify-center">
      <div className="max-w-7xl w-full p-4">
        ...
        <motion.h1
          ...
          className="optigurney text-5xl sm:text-7xl md:text-9xl text-center mt-20"
        >
          {splitStringUsingRegex("MX. AAPASC").map((char, index) => (
        ...
        <section className="bg-white py-12">
          ...
          >
            <div>
              ...
              >
                Placeholder description for Mx. Aapasc. You can replace this with the actual description later.
              </motion.h2>

              {/* Placeholder Image with Transition */}
              <motion.div
              ...
              >
                <LazyLoadImage
                  src="https://res.cloudinary.com/dq6oea49h/image/upload/t_4to3/v1723870129/CF-_Eaj_SB-8_dapmt3.jpg" // Replace with an existing image path for now
                  alt="Mx. Aapasc Event Placeholder"
                  effect="blur"
              ...
              {[
                {
                  ...
                  description: "Mx. Aapasc is a major event celebrating AAPI culture",
                  iconPath:
                    "M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z M17.8 13.938h-.011a7 7 0 1 0-11.464.144h-.016l.14.171c.1.127.2.251.3.371L12 21l5.13-6.248c.194-.209.374-.429.54-.659l.13-.155Z"
                },
                {
                  title: "Community Involvement",
                  description: "Bringing together diverse voices from across the community",
                  iconPath:
                    "M12 6a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm-1.5 8a4 4 0 0 0-4 4 2 2 0 0 0 2 2h7a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-3Zm6.82-3.096a5.51 5.51 0 0 0-2.797-6.293 3.5 3.5 0 1 1 2.796 6.292ZM19.5 18h.5a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-1.1a5.503 5.503 0 0 1-.471.762A5.998 5.998 0 0 1 19.5 18ZM4 7.5a3.5 3.5 0 0 1 5.477-2.889 5.5 5.5 0 0 0-2.796 6.293A3.501 3.501 0 0 1 4 7.5ZM7.1 12H6a4 4 0 0 0-4 4 2 2 0 0 0 2 2h.5a5.998 5.998 0 0 1 3.071-5.238A5.505 5.505 0 0 1 7.1 12Z"
                },
                {
                  title: "Performances",
                  description: "Featuring talented artists from the AAPI community",
                  iconPath:
                ...
                },
                {
                  ...
                  description: "Featuring local AAPI-owned businesses",
                  iconPath:
